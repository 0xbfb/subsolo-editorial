...
import { createCanonicalUrl, createEntityId, createSlug, createUlid, isEntityId, isValidRevisionStep, nextRevision } from '../../src/lib/domain/identifiers';
...
describe('identificadores públicos', () => {
  ...
  it('gera slug ASCII e URL canônica', () => {
    ...
    expect(createCanonicalUrl('https://subsolo.example/', '2026-07-20T08:00:00-03:00', slug)).toBe(`https://subsolo.example/2026/07/20/${slug}/`);
  });
