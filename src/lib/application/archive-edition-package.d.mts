import type { PackageArchivePlan, PackageArchivePort, PackageArchiveReceipt } from '../domain/package-archive';
...
export function planPackageArchive(input: Readonly<{
  packagePath: string;
  rootFolderId: string;
...
export function applyPackageArchive(input: Readonly<{
  packagePath: string;
  rootFolderId: string;
  receiptPath?: string | null;
  adapter: PackageArchivePort;
