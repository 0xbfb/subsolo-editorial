...
export interface EditorialDocumentProvider {
  read(documentId: string): Promise<EditorialDocument>;
}
export interface EditorialSheetProvider {
  read(articleId: string): Promise<EditorialSheetRow>;
}
